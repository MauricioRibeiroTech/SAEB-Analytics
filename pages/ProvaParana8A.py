...
def load_data():
    ...
    df = pd.read_csv("pages/PPR_8A.csv", sep=";", decimal=",", encoding='utf-8-sig')
...
with st.sidebar:
    ...
    <div style="text-align: center; margin-bottom: 20px;">
        <h1 style="color: #2c3e50; font-size: 24px;">Análise PPR 8º Ano</h1>
...
<div class="header">
    ...
    <h2 style="text-align: center; margin: 0;">8º Ano - PPR 2025</h2>
</div>
""", unsafe_allow_html=True)
